...
class FEATURE_VARIATION_CATALOG(Enum):
    ...
    EWALLET_PAYMENT = TestEwalletPayment
...
PAYMENT_ROUTING_PAYMENT_URL = f"{BASE_URL}/call/payment/paymentrouting"
CREDIT_CARD_PAYMENT_URL = f"{BASE_URL}/call/payment/creditcard"
INVOICE_PAYMENT_URL = f"{BASE_URL}/call/payment/invoice"
...
SELECTED_FEATURE_VARIATION = [
    ...
    [FEATURE_VARIATION_CATALOG.EWALLET_PAYMENT, VENDOR_CATALOG.OY],
