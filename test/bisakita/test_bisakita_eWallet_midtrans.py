...
class TestEWalletMidtrans():
  ...
  def test_eWallet_midtrans(self):
    ...
    dropdown.find_element(By.XPATH, "//option[. = 'EWallet']").click()
    time.sleep(2)
    ...
    time.sleep(1)
    self.driver.find_element(By.NAME, "ewallet_type").send_keys("gopay")
    time.sleep(1)
