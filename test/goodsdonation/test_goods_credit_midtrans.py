...
class TestCreditCardMidtrans():
  ...
  def test_credit_card_midtrans(self):
    ...
    time.sleep(1)    
    self.driver.find_element(By.NAME, "token_id").click()
    time.sleep(1)
    self.driver.find_element(By.NAME, "token_id").send_keys("48111111-1114-6be6dfec-98d6-4de4-8196-d7dccd6e4088")
    time.sleep(1)
    ...
    if rows:
        ...
        assert_unique_attribute_exists(self.driver, "Credit Card")
