...
class TestRetailMidtrans():
  ...
  def test_retail_midtrans(self):
    self.driver.get("https://goodsdonation.amanah-staging.cs.ui.ac.id/")
    time.sleep(2)
    ...
    dropdown.find_element(By.XPATH, "//option[. = 'Retail Outlet']").click()
    time.sleep(2)
    ...
    time.sleep(1)    
    self.driver.find_element(By.NAME, "retail_outlet").click()
    time.sleep(1)
    self.driver.find_element(By.NAME, "retail_outlet").send_keys("indomaret")
    time.sleep(1)
    ...
    expected_url = "https://goodsdonation.amanah-staging.cs.ui.ac.id/viapaymentgateway/list"
    ...
    if rows:
        ...
        assert_unique_attribute_exists(self.driver, "Retail Outlet")
