...
class TestdebitcardMidtrans():
  ...
  def test_debit_midtrans(self):
    ...
    time.sleep(1)
    self.driver.find_element(By.NAME, "payment_type").click()
    time.sleep(1)
    self.driver.find_element(By.NAME, "payment_type").send_keys("danamon_online")
    time.sleep(1)
    ...
    expected_url = "https://charityschool.amanah-staging.cs.ui.ac.id/viapaymentgateway/list"
    ...
    if rows:
        ...
        assert_unique_attribute_exists(self.driver, "debitCard")
