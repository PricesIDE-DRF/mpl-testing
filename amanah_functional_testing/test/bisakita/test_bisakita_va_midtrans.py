...
class TestVAMidtrans():
  ...
  def test_vA_midtrans(self):
    ...
    dropdown.find_element(By.XPATH, "//option[. = 'Virtual Account']").click()
    time.sleep(2)
    ...
    time.sleep(1)
    self.driver.find_element(By.NAME, "bank").send_keys("mandiri")
    time.sleep(1)
    ...
    if rows:
        ...
        assert_unique_attribute_exists(self.driver, "Virtual Account")
