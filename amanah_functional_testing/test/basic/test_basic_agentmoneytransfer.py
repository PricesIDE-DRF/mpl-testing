...
class TestAgentMoneyTransfer():
  ...
  def test_agentmoneyTransfer(self):
    ...
    time.sleep(1)
    dropdown.find_element(By.XPATH, "//option[. = 'Agent Money Transfer']").click()
    time.sleep(1)
    self.driver.find_element(By.CSS_SELECTOR, ".btn-primary").click()
    
        
    # Form data
    self.driver.find_element(By.NAME, "agent_id").click()
    self.driver.find_element(By.NAME, "agent_id").send_keys("17")
    self.driver.find_element(By.NAME, "account_number").click()
    self.driver.find_element(By.NAME, "account_number").send_keys("61234578")
    ...
    self.driver.find_element(By.NAME, "remark").send_keys("Dummy Remark")
    self.driver.find_element(By.NAME, "amount").click()
    self.driver.find_element(By.NAME, "amount").send_keys("123456")
    self.driver.find_element(By.CSS_SELECTOR, ".form-control:nth-child(7) > .input").click()
    self.driver.find_element(By.CSS_SELECTOR, ".form-control:nth-child(7) > .input").send_keys("tarik selenium")
